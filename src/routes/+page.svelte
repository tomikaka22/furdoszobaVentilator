...
<div class="flex justify-center items-center mt-10 py-4 gap-5 outline outline-1 mx-9 max-w-lg rounded-3xl">
	<svg class:rotating={data.relay} xmlns="http://www.w3.org/2000/svg" height="8rem" class="transition-all" fill="currentColor" viewBox="80 -880 800 800">
	...
	<div class="flex flex-col text-xl text-left">
		<b>Ventilátor:</b>
		<p class="font-semibold text-primary w-28 flex flex-col justify-center items-start text-left">{data.relay ? 'Bekapcsolva.' : 'Kikapcsolva.'}</p>
	</div>
</div>
