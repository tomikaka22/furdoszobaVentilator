...
<main class="absolute top-0 bottom-0 left-0 right-0 -z-10 flex flex-col justify-center items-center">
	...
	<div class="w-full flex items-center flex-col gap-4 mb-10">
		<h1 class="font-semibold text-3xl text-primary">Páratartalom</h1>
		...
		<div class="text-center">
			<p>
				Ha a <b class="text-lg text-primary">páratartalom</b>
				{#key data.thresh}
					<span in:fade class="text-lg font-extrabold text-primary inline-block">> {data.thresh}%</span>
				{/key}
			</p>
			<p>A ventilátor <b class="text-lg text-primary">bekapcsol.</b></p>
		</div>
	</div>
